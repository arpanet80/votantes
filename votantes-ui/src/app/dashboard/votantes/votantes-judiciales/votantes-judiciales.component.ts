...
@Component({
  selector: 'app-votantes-judiciales',
  imports: [ReactiveFormsModule, ControlMessagesComponent, SpinnerComponent, DatePipe],
  templateUrl: './votantes-judiciales.component.html',
  styleUrl: './votantes-judiciales.component.css',
})
export class VotantesJudicialesComponent {
